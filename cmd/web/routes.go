...
func (app *application) routes() http.Handler {
	...
	// which will be used for every request that application receives.

	standardMiddleware := alice.New(app.recoverPanic, app.logRequest, secureHeaders)

	// Creating a new middleware chain containing the middleware specific to dynamic application routes.
